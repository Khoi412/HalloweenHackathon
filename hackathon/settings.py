...
INSTALLED_APPS = [
    ...
    # Other installed apps (for Heroku deployment and external services)
    'dj_database_url',
    'gunicorn',
    'cloudinary',
    'allauth', 
...
TEMPLATES = [
    {
        ...
        # This line points Django to the new project-level 'templates' folder
        'DIRS': [os.path.join(BASE_DIR, 'templates')],
        'APP_DIRS': True, # This line ensures Django searches inside the 'costumes/templates/costumes' folder
        'OPTIONS': {
            'context_processors': [
...
ACCOUNT_AUTHENTICATION_METHOD = 'username'  # You can change to 'email' if you prefer
